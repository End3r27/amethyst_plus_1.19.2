...
public class ModArmorEffectsMK1 {
    ...
    private static void applyEffects(PlayerEntity player) {
        ...
        if (isWearingFullCustomArmor(player)) {
            ...
            for (int i = 0; i < player.getInventory().armor.size(); i++) {
                ...
                Item helmet = ModArmors.ENERGIZED_AMETHYST_HELMET;
                Item chestplate = ModArmors.ENERGIZED_AMETHYST_CHESTPLATE;
                Item leggings = ModArmors.ENERGIZED_AMETHYST_LEGGINGS;
                Item boots = ModArmors.ENERGIZED_AMETHYST_BOOTS;
    ...
    private static boolean isWearingFullCustomArmor(PlayerEntity player) {
        return isCustomArmor(player.getInventory().getArmorStack(3), ModArmors.ENERGIZED_AMETHYST_HELMET) &&
               isCustomArmor(player.getInventory().getArmorStack(2), ModArmors.ENERGIZED_AMETHYST_CHESTPLATE) &&
               isCustomArmor(player.getInventory().getArmorStack(1), ModArmors.ENERGIZED_AMETHYST_LEGGINGS) &&
               isCustomArmor(player.getInventory().getArmorStack(0), ModArmors.ENERGIZED_AMETHYST_BOOTS);
    }
