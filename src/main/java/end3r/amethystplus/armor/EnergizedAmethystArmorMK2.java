...
public class EnergizedAmethystArmorMK2 extends ArmorItem {
    public static final int MAX_ENERGY = 50000;           // Maximum energy storage
    private static final int ENERGY_DRAIN_PER_SECOND = 15; // Energy consumed per second

    public EnergizedAmethystArmorMK2(EquipmentSlot slot, Settings settings) {
        super(new CustomArmorMaterialMK2(), slot, settings); // Uses a custom armor material
    }
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.literal("Haste II and Jump Boost II.").formatted(Formatting.GRAY));
